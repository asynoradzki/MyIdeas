...
VALUES ('2023-05-01', 'Monday Thread 1', 'Description for Thread 1', 'Justification for Thread 1',
        '/downloadFile/7c4f62af-278e-4699-bc89-f152cb088d20', 10, 6, 1, 1, 1),
       ('2023-05-02', 'Monday Thread 2', 'Description for Thread 2', 'Justification for Thread 2', '', 20, 2,
        2, 2, 1),
       ('2023-05-03', 'Tuesday Thread 3', 'Description for Thread 3', 'Justification for Thread 3', '', 15, 3,
        1, 1, 2),
       ('2023-05-04', 'Tuesday Thread 4', 'Description for Thread 4', 'Justification for Thread 4', '', 25, 4,
        2, 2, 2),
       ('2023-05-05', 'Tuesday Thread 5', 'Description for Thread 5', 'Justification for Thread 5', '', 18, 1,
        1, 1, 1),
       ('2023-05-06', 'Wednesday Thread 6', 'Description for Thread 6', 'Justification for Thread 6', '', 12,
        2, 2, 2, 1),
       ('2023-05-07', 'Wednesday Thread 7', 'Description for Thread 7', 'Justification for Thread 7', '', 30,
        3, 1, 1, 2),
       ('2023-05-08', 'Wednesday Thread 8', 'Description for Thread 8', 'Justification for Thread 8', '', 22,
        4, 2, 2, 2),
       ('2023-05-09', 'Wednesday Thread 9', 'Description for Thread 9', 'Justification for Thread 9',
        '/downloadFile/photo9.jpg', 17,
        1, 1, 1, 1),
       ('2023-05-10', 'Wednesday Thread 10', 'Description for Thread 10', 'Justification for Thread 10', '',
        28, 2, 2, 2, 1);
...
INSERT INTO votes (thread_id, user_id, vote_type)
VALUES (1, 1, 'LIKE'),
       (1, 2, 'LIKE'),
       (1, 3, 'LIKE'),
       (1, 4, 'DISLIKE');
