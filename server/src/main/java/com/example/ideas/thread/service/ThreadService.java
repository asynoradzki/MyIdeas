...
//        threadRepository.delete(thread);
    ...
    public ThreadResponseDTO updateThreadById(
        ...
        } else if (multipartFile != null && multipartFile.isEmpty() && !thread.getPhoto().isEmpty()) {
    ...
    public ThreadResponseDTO updatePointsInThreadById(Long threadId, Integer points) throws EntityNotFoundException {
        Thread thread = getObjectFromDB(threadId, threadRepository);

        thread.setPoints(points);
